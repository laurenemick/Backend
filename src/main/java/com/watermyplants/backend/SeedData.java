...
public class SeedData implements CommandLineRunner
{
    ...
    public void run(String... args) throws Exception {
        ...
        User u1 = new User("admin", "admin@admin.com", "12345678", "password", "http");
        u1.getRoles().add(new UserRoles(u1, role1));
        u1.setPassword("password");
        User u2 = new User("nick", "test1@admin.com", "12345678", "password", "http");
        u2.getRoles().add(new UserRoles(u2, role2));
        User u3 = new User("lucy", "test2@admin.com", "12345678", "password", "http");
        u3.getRoles().add(new UserRoles(u3, role2));
        User u4 = new User("fred", "test3@admin.com", "12345678", "password", "http");
